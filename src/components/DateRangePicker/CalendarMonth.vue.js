...
for (const [week, wi] of __VLS_vFor((__VLS_ctx.weeks))) {
    ...
    for (const [cell] of __VLS_vFor((week))) {
        ...
        const __VLS_1 = __VLS_asFunctionalComponent1(__VLS_0, new __VLS_0({
            ...
            key: (cell.iso),
            cell: (cell),
            isStart: (cell.inCurrentMonth && __VLS_ctx.isStart(cell.date)),
            isEnd: (cell.inCurrentMonth && __VLS_ctx.isEnd(cell.date)),
            isInRange: (cell.inCurrentMonth && __VLS_ctx.isInRange(cell.date)),
            isHoverRange: (cell.inCurrentMonth && __VLS_ctx.isHoverRange(cell.date)),
